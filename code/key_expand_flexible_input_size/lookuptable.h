...
#define sbox(x) (sboxOld[x])
#define galois2(x) (galois2Old[x])
#define galois3(x) (galois3Old[x])
#define rcon(x) (rconOld[x])

static const uint8_t sboxOld[256] = {
...
//Lookup Table for Galois Multiplication by 2    
static const uint8_t galois2Old[256] = {
    0,    0x2,  0x4,  0x6,  0x8,  0xa,  0xc,  0xe,  0x10, 0x12, 0x14, 0x16,
    ...
    0x13, 0x11, 0x17, 0x15, 0xb,  0x9,  0xf,  0xd,  0x3,  0x1,  0x7,  0x5,
...
//Lookup Table for Galois Multiplication by 3  
static const uint8_t galois3Old[256] = {
    0,    0x3,  0x6,  0x5,  0xc,  0xf,  0xa,  0x9,  0x18, 0x1b, 0x1e, 0x1d,
    ...
    0xb,  0x8,  0xd,  0xe,  0x7,  0x4,  0x1,  0x2,  0x13, 0x10, 0x15, 0x16,
    0x1f, 0x1c, 0x19, 0x1a,
};


//! The Round Constant (Rcon) table used in the key schedule.
static const uint8_t rconOld[] = {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40,
