...
int aes_key_size = AES_KEY_SIZES[aes_version_id];
...
int main(int argc, char** argv) {
    ...
    for (int j = 0; j < num_tests; j++) {
        ...
        int test_running_time = 0;
        int test_kernel_accesses = 0;
